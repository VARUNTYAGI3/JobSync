  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900">
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-4 py-16 sm:px-6 lg:grid-cols-[1.1fr_0.9fr] lg:px-8 lg:py-24">
          <div className="max-w-2xl">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <a
                href="/jobs"
                className="inline-flex items-center gap-2 rounded-full bg-blue-600 px-5 py-3 text-sm font-semibold text-white shadow-lg shadow-blue-600/20 transition duration-300 hover:bg-blue-700"
              >
                Explore jobs
              ...
              <a
                ...
                className="rounded-full border border-slate-200 bg-white px-5 py-3 text-sm font-semibold text-slate-700 transition duration-300 hover:border-blue-200 hover:text-blue-600"
              >
                Hire talent
              </a>
            </div>
          ...
          <div className="rounded-[32px] border border-slate-200 bg-slate-50 p-5 shadow-[0_20px_60px_-25px_rgba(15,23,42,0.16)]">
              ...
              <div className="mt-6 rounded-2xl border border-slate-200 bg-slate-50 p-4">
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  {companies.map((company) => (
                    <span key={company} className="rounded-full border border-slate-200 bg-white px-3 py-1 text-sm font-medium text-slate-600">
                      {company}
                    </span>
                  ))}
                </div>
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid gap-4 md:grid-cols-3">
          {features.map((feature) => {
            ...
            return (
              <div key={feature.title} className="rounded-[24px] border border-slate-200 bg-white p-6 shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-md">
      ...
      <section className="mx-auto max-w-7xl px-4 pb-16 sm:px-6 lg:px-8">
        <div className="rounded-[32px] border border-slate-200 bg-white p-8 shadow-[0_20px_60px_-25px_rgba(15,23,42,0.16)] sm:p-10">
